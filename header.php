...
<html lang="en">
  <head>
    ...
    <title>Aplikasi Penggajian PT. Kujang Tatar Persada</title>
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a href="cetak_laporan_pegawai.php">Lapora Data Pegawai</a></li>
                ...
                <li><a href="laporan_kehadiran.php">Laporan Data Kehadiran Pegawai</a></li>
