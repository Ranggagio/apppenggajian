				...
				<form method="post" action="aksi_kehadiran.php?act=insert">
					<table class="table">
						...
						?>
							<tr>
									<td colspan="10"></td>
										<label class="label label-warning">Bulan dan tahun yang dipilih sudah diproses silahkan lakukan edit data</label>
									</td>
								</tr>
						<?php	
						}
			...
			<div class="panel-body">
				<div class="alert alert-info">
					...
					<table class="table">
						...
						<?php$no=1;
						$query=mysqli_query($konek, "SELECT master_gaji.*,pegawai.nama_pegawai, jabatan.nama_jabatan FROM master_gaji
							INNER JOIN pegawai ON master_gaji.nip=pegawai.nip
							INNER JOIN jabatan ON pegawai.kode_jabatan=jabatan.kode_jabatan
							WHERE master_gaji.bulan='$bulantahun'
