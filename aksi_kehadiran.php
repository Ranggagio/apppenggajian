...
if(isset($_GET['act'])){
	...
	if($_GET['act']=='insert'){
		...
		$sql = "INSERT INTO master_gaji(bulan,nip,masuk,ssakit,izin,alpha,lembur,potongan) VALUES ";
	...
	elseif($_GET['act']=='update'){
		...
		for($i=0; $i < $count; $i++){
			$update = mysqli_query($konek, "UPDATE master_gaji SET masuk='$masuk[$i]', sakit='$sakit[$i]',izin='$izin[$i]',alpha='$alpha='$alpha[$i]',lembur='$lembur[$i]',potongan='$potongan='$potongan[$i]'
